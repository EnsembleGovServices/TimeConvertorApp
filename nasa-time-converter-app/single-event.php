        ...
        <div class="container">
            <article id="event-<?php echo get_the_ID(); ?>" <?php post_class(); ?>>
                <div class="single_event_cookie_store">
                   ...
                   // error_log(print_r($DateAndTime, true));
                    ...
                    <h1 class="eve_heading heading_launch">
                        <?php if (!empty($event_nasa_launch_c)) {
                            _e('NASA’s ' . get_the_title() . ' launch will be at ', 'nasa-tca');
                        } ?>
                        <span></span>
                    </h1>
                    ...
                    <div class="wrap_eve_details">
                                        ...
                                        <div class="eve_tz_sing_wrap__inner">
                                            ...
                                            <?php if (!empty($event_nasa_launch_c)) { ?>
                                                <div class="eve_tz_sing">
                                                    ...
                                                    <p class="launch_D eve_d_<?php _e(get_the_ID()); ?>"> </p>
                                                </div>
                                            <?php }
                                            // Broadcast Date
                                            if (!empty($event_nasa_broadcast_c)) { ?>
                        ...
                        <div class="btns-eve-wrap">
                            ...
                            <div class="reset_eve_b">
                                <!-- Reset button -->
                                <button data_reset_id="<?php if (!empty($eve_cookie_store_id)) {
                                                            echo esc_attr($eve_cookie_store_id);
                                                        } ?>" class="reset_eve_btn reset_btn_hide">
                            ...
                            <div class="convo_eve_b">
                                ...
                                <a href="<?php echo esc_url(get_the_permalink()); ?>" eve-id=<?php if (!empty(get_the_ID())) {
                                                                                                    echo esc_attr(get_the_ID());
                                                                                                                ...
                                                                                                                }  ?>" eve-date="<?php if (!empty($event_nasa_launch_c)) {
                                                                                                                                        echo converToTzFormat($event_nasa_launch_c, $event_nasa_tz_c, $event_nasa_tz_c, DateTime::ATOM);
                                                                                                                                    } ?>" eve-broad-date="<?php if (!empty($event_nasa_broadcast_c)) {
                                                                                                                                                                echo converToTzFormat($event_nasa_broadcast_c, $event_nasa_tz_c, $event_nasa_tz_c, DateTime::ATOM);
                                                                                                                                                            } ?>" eve-timezone="<?php if (!empty($event_nasa_tz_c)) {
                                                                                                                                                                                    echo esc_attr($event_nasa_tz_c);
                                                                                                                                                                                } ?>" popup-open-eve="popup-h-single_eve" class="covert_timezone_btn read_bio_single_eve open-button">
                        ...
                        data: {
                            ...
                            values: {
                                ...
                                if (!empty($event_nasa_tz_c)) { ?>
                                    <?php echo sd_nasa_fetchtimezone_data($event_nasa_tz_c, 'countryCode'); ?>: {
                                ...
                                if (isset($eve_cookie_store_state) && !empty($event_nasa_tz_c)) { ?>
                                    <?php echo sd_nasa_fetchtimezone_data($eve_cookie_store_state, 'countryCode'); ?>: {
                                        launch_d_svg: "<?php if (!empty($event_nasa_launch_c)) { ?>" +
