                                    ...
                                    <div class="select_ur_timezone">
                                        ...
                                        <div class="sel_timezone_call_tz">
                                            <div class="wrap_tz_aj">
                                                ...
                                                <div class="timezone_via_key all_tz_ky"></div>
                                            </div>
                                            <input type="submit" value="<?php esc_attr_e('Confirm', 'nasa-tca'); ?>" class="disable_btn_confirm all_confirm_btn" disabled="disabled">
                                        </div>
                                    </div>
                                </div>
                ...
                <?php while ($loop->have_posts()) : $loop->the_post();
                    ...
                    if (isset($eve_l_b_date)) {
                        if (!empty($timezoneset_cookie_name)) {
                            ...
                            $date_s->setTimezone(new DateTimeZone($timezoneset_cookie_name));
                        } else {
                            if (!empty($eve_cookie_store_id) && !empty($eve_cookie_store_state)) {
                                if (get_the_ID() == $eve_cookie_store_id) {
                                    $date_s = new DateTime($eve_l_b_date, new DateTimeZone($default_timezone));
                                    $date_s->setTimezone(new DateTimeZone($eve_cookie_store_state));
                                } else {
                    ...
                    <div class="single_content_wrap">
                        ...
                        <div class="select_ur_timezone">
                            ...
                            <div class="sel_timezone_csingle_eve">
                                ...
                                <input type="submit" value="<?php esc_attr_e('Confirm', 'nasa-tca'); ?>" class="disable_btn_confirm confirm_btn single_eve_tz_p" disabled="disabled" single_event_src="" event_id_c="" single_event_date="" single_eve_broad_date="">
                            </div>
                        </div>
                    </div>
